...
namespace DoodleUp.Runtime
{
    ...
    public static class LastShiftHullShell
    {
        ...
        ///
        /// <b><c>48 -> 32</c> 로 내렸다</b>(2026-08-10). 아트 킷의 외피 패널이
        /// <c>LPK_Hull_Exterior_Panel_4m</c> 라 한 분할에 한 장을 두르려면 현이 <c>4m</c> 여야
        /// 하는데, 반경 <c>20m</c> 에서 현은 <c>2 * R * sin(pi / n)</c> 이다 —
        /// <c>48</c> 분할이면 <c>2.616m</c> 라 겹쳐 둘러야 하고 그 겹침이 z-fighting 을 만든다.
        /// <c>32</c> 분할이면 <c>3.921m</c> 로 오차 <c>2%</c> 안에 든다.
        ///
        /// 배치 판정은 안 깨진다 — 내접 유효 반경이 <c>19.957m</c> 에서 <c>19.904m</c> 로만
        /// 줄어, 최원 모서리(숙소 <c>16.971m</c>) 대비 여유가 <c>2.933m</c> 로 요구
        /// <c>2.400m</c> 를 넘는다.
        /// </summary>
