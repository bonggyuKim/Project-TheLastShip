...
DU-02 증거 범위는 기존 sampling/reset/task-state다. DU-03A 공통 StrokeSession backend와 Confirm capsule chain 검증은 `docs/qa/du-03a-verification.md`를 따른다. Aim/Trajectory 완성 adapter와 traverse gameplay는 후속 단계 범위다.
