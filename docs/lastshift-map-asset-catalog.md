...
| `Panel_BowWall` | 조종실 선수벽 | 선수 방향을 잡고 조종실의 계기 밀도를 보강하는 세로 계기판 | 실제 벽 패널 킷 대체 전 유지 |
| `Panel_SternWall` | 생명유지실 선미벽 | 선미 방향을 잡고 생명유지 설비의 계기 밀도를 보강하는 세로 계기판 | 실제 벽 패널 킷 대체 전 유지 |
| `Panel_Cockpit/Power/Cooling/LifeSupport` | 각 방의 외벽 | 방별 상태색 readout을 담는 벽 패널 | 실제 벽 패널 킷 대체 전 유지 |
