...
기본 3회 프리뷰에서 입 경계 36정점은 고정된 채 나머지 5,675정점이 이동했고,
최대 이동은 캐릭터 대각선의 0.45%였다. 동일 토폴로지에서 Laplacian 요철
평균은 15.67% 감소했다.
...
손가락과 발가락 판독성이 유지된다. 눈 주변·목·전완·허벅지의 작은 면 꺾임은
줄었지만 다리 안쪽의 기존 삼각형 흐름은 남아 있어, 실제 제작 적용 전 스킨 자세
검증은 생략할 수 없다.
